...
前几天，发了一篇文章，介绍了一下[JVM内存结构 VS Java内存模型 VS Java对象模型](/2018/11/01/再有人问你Java内存模型是什么-就把这篇文章发给他/)。有很多小伙伴反馈希望可以深入的讲解下每个知识点。Java内存模型，是这三个知识点当中最晦涩难懂的一个，而且涉及到很多背景知识和相关知识。
